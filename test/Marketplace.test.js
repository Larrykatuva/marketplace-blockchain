...
contract('Marketplace', ([deployer, seller, buyer]) => {
    ...
    describe('products', async () => {
        ...
        it('creates products', async () => {
            ...
            assert.equal(event.id.toNumber(), productCount.toNumber(), 'is is correct')
        ...
        it("lists product", async() => {
            ...
            assert.equal(product.id.toNumber(), productCount.toNumber(), 'is is correct')
        ...
        it('sells product', async () => {
            ...
            const result = await marketplace.purchaseProduct(
                productCount,
